...
<body>
    <div class="sidebar" id="sidebar">
        ...
        <div class="custom-position1" >
            <h1 class="modal-title">Eliminar Gerentes</h1>
        </div>
                ...
                <div class="custom-zice2">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-title">Eliminar Gerente</h5>
                            <form>
                                <!-- Se crea un espacio para ingresar los datos -->
                                <div class="form-group">
                                    <!-- Titulo para el dato a ingresar -->
                                    <label for="nameInput">ID</label>
                                    <!-- Se crea el espacio donde se mostraran 
                                    los datos delgerente a eliminar -->
                                ...
                                de color rojo para eliminar los datos -->
